...
<template>
  <div>
    ...
    <div class="w-full max-h-600px overflow-y-scroll overflow-x-hidden">
      ...
      >
        <div
          v-for="(items, index) in displayedCards"
          :key="index" class="flex flex-col border border-transparent rounded-lg bg-#2c2c2c mx-2 my-5 hover:bg-#5f5f5f hover:scale-103% transition-transform duration-300" @mouseenter="assetsDisplay(index)"
